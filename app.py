...
@app.route('/')
def home():
    # Redirect to the recommend route with example parameters
    return redirect("/recommend?user_id=J9fxJlZ1UHWmY8lqhkkKri2IbIj1&top_n=3", code=302)
...
def recommend():
    try:
        ...
        try:
            ...
            return jsonify({"error": "Invalid value for top_n. Must be an integer."}), 400
